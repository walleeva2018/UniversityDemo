<template>
  <div>
    <img src="../assets/fee.jpg" style="max-height: 500px; width: 100%" />
...
import FeeSection1 from '../components/FeeComponents/FeeSection1.vue';
import FeeSection2 from '../components/FeeComponents/FeeSection2.vue';
