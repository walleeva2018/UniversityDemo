    ...
    <div class="accordion">
      ...
      <div class="accordion-item">
        ...
        <label for="accordion1" class="accordion-item-title"
          ><span class="icon"></span>What events are happening at the University of Prieston?</label
        >
        <div class="accordion-item-desc">
          Experience the vibrant campus life at Prieston through our exciting events and activities. From
          cultural festivals to academic symposiums, there's always something happening on campus to engage
      ...
      <div class="accordion-item">
        ...
        <label for="accordion2" class="accordion-item-title"
          ><span class="icon"></span>What cultural events can students participate in?</label
        >
        <div class="accordion-item-desc">
          Embrace cultural diversity and join us in celebrating various traditions and customs at Prieston.
          From international food fairs to traditional dance performances, our cultural events offer a rich
